...
import rmlogo from '../assets/Logo.svg'
          ...
          <div className="flex flex-row gap-0">
            ...
            <div className="flex flex-col items-center justify-center leading-6">
              <motion.p
                ...
                style={{ color:scrolled?"white": "#1e3a8a" }}
                className={`${scrolled?"white":"text-blue-900"} text-shadow-md text-white text-[25px] font-bold cursor-pointer`}
              >
                &nbsp;PowerbrainLabs
              </motion.p>
              <motion.span
